...
## tools/porting/boards/_boards_json/\[board].json
...
## tools/porting/boards/\[board]/interface.cpp
This is where you do the board specific setup code

## tools/porting/boards/\[board]/\[board].ini
This is the platformio config for the device. Look at other boards for whats needed.

Partition tables shared across boards live under `tools/build/partitions/`.
