...
void _post_setup_gpio() {
    ...
    kvxConfigPins.rfTx = 8;
    kvxConfigPins.rfRx = 9;
    ...
    kvxConfigPins.i2c_bus.sda = (gpio_num_t)GROVE_SDA;
    kvxConfigPins.i2c_bus.scl = (gpio_num_t)GROVE_SCL;
}
