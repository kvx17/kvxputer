...
def prepare_www_files():
    ...
    data_src_dir = join(env.get("PROJECT_DIR"), "tools/build/embedded_resources/web_interface")
    ...
    with open(HEADER_FILE, "w") as header:
        ...
        header.write(
            "// THIS FILE IS AUTOGENERATED DO NOT MODIFY IT. MODIFY FILES IN /tools/build/embedded_resources/web_interface\n\n"
        )
