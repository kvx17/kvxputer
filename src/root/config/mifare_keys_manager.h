 ...
 * This class is used internally by KvxputerConfig
 * External code should use KvxputerConfig.mifareKeys directly
 */
class MifareKeysManager {
public:
    // Constants
    static constexpr const char *KEYS_PATH = kvx::paths::MIFARE_KEYS;
    static constexpr const char *KEYS_DIR = kvx::paths::RFID;
