...
#include "root/app/type_convertion.h" // decimalToHexString
#include "helpers.h"
#include "menu/rf/protocols/rf_config.h"   // RF_DEBUG
#include "menu/rf/protocols/rf_encoder.h"  // rf_tx_protocol, rf_encoder_selftest
#include "menu/rf/protocols/rf_keeloq.h"   // rf_keeloq_selftest
#include "menu/rf/protocols/rf_registry.h" // rf_find_protocol
...
void createRfRxCommand(Command *rfCmd) {
    ...
    cmd.addPosArg("frequency", String(kvxConfigPins.rfFreq).c_str());
    cmd.addFlagArg("raw");
}
