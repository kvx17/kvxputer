...
void drawTime() {
    tft.drawPixel(0, 0, 0);
    tft.fillRect(80, 0, display_w, canvas_top_h - 3, kvxConfig.bgColor);
...
void drawTopCanvas() {
    ...
    // draw screen
    tft.drawPixel(0, 0, 0);
    tft.fillRect(0, 0, display_w, canvas_top_h, kvxConfig.bgColor);
    tft.drawString(buffer, 0, 3);
    tft.drawLine(0, canvas_top_h - 1, display_w, canvas_top_h - 1, kvxConfig.priColor);
}
...
void drawBottomCanvas() {
    ...
    // draw screen
    tft.drawPixel(0, 0, 0);
    tft.fillRect(0, canvas_bot_h, display_w, canvas_bot_h + 10, kvxConfig.bgColor);
    tft.drawString("NOT AI", display_w, canvas_bot_h + 5);
    tft.drawLine(0, canvas_bot_h, display_w, canvas_bot_h, kvxConfig.priColor);
}
...
void drawMood(const String &face, const String &phrase, bool broken) {
    ...
    // draw screen
    tft.drawPixel(0, 0, 0);
    tft.fillRect(0, canvas_top_h + 10, display_w, canvas_bot_h - 40, kvxConfig.bgColor);
