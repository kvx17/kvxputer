...
// like kvxConfigPins from here. On GDO0 the noise can fire this thousands of times/s; if it
...
void rf_listen() {
    ...
    newPulse = false;
    attachInterrupt(digitalPinToInterrupt(kvxConfigPins.CC1101_bus.io0), onPulse, RISING);
    displayRedStripe("Listening...", getComplementaryColor2(kvxConfig.priColor), kvxConfig.priColor);
    ...
    detachInterrupt(digitalPinToInterrupt(kvxConfigPins.CC1101_bus.io0));
}
