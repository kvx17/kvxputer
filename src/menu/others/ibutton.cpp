...
static void writeByte_RW1990(byte data) {
    uint8_t pin = kvxConfigPins.iButton;
...
static const char *IBUTTON_DIR = kvx::paths::IBUTTON;
...
void setiButtonPinMenu() {
    ...
    loopOptions(options, kvxConfigPins.iButton + 1);
    options.clear();
    kvxConfigPins.setiButtonPin(sel);
}
